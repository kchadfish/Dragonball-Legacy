...
Requirement(s): 1,000 HP (Base + Gear)
...
Effect: Twice per match, you may lose 1 KI Point and choose to not roll a defensive roll against an UNRESTRICTED single dice attack. If you do, the attack is STOPPED and COUNTERED. Your attacks performed during a COUNTER deal +(10% Power) Damage and cost -1 KI Point.
Skills
