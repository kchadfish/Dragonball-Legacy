...
Solo Only
Requirement(s): No SEVERed limbs
...
Effect: +15% HP. Once per match, you may perform an UNRESTRICTED Advanced Attack from your Style that you have not learned. You must pay the KI cost of that attack +1 to use this ability.
...
Requirement(s): Must not have taken Saiba Survival.
...
Requirement(s): Must not have taken Kill 'Em All.
...
Requirement(s): Must not have taken Save the Princess.
...
Requirement(s): Must not have taken Royal Pains.
...
Requirement(s): Joint Mandatory, at least 2 players.
...
Requirement(s):The Prince and the Pauper
...
Description: The power of a LSSJ is beyond measure. Anyone who dares approach him will see that might first hand.
Effect: You start combat Transformed and with + 1 ki.
Requirements: N/A
Training Days: 2
