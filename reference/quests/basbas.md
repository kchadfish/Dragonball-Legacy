...
Source: https://www.tapatalk.com/groups/dragonballlegacy1/basbas-quests-t415.html
...
Skills.
## Blessing of the Mystics [FREESTYLE, LATENT SKILL]
Description: In return for saving their grand temple, the Mystics of Konos blessed you with a ritual that keeps you in tune with your maximum potential at all times.
Effect: This Skill does not take up a Skill slot. You do not have to perform Transformation Rolls to remain in a Transformed state.
## Visage Flux [FREESTYLE, LATENT SKILL]
Description: The user taps into residual magics to transfer their power into an entirely different form, allowing them to shift their Transformation into another instantly.
Effect: Once per combat, if you are Transformed, you may take on an alternate Transformation without first reverting back to Base Form or taking up your turn. You may not use this Skill if you are below 50% of your max HP. This does not take up one of your Skill slots.
...
Fusion Dance [FREESTYLE, LATENT SKILL]
Effect: Allows Fusion Dance Fusion.
...
## Fool's Fury [FREESTYLE, CUSTOM, CONSTANT SKILL]
Description: Sometimes the frustration of fighting an untouchable opponent can wear on a person's nerves, and they start to throw extra moves in just to try to make sure something sticks. Unfortunately for them, Dario sees more incoming attacks as more opportunities to catch his opponents offguard.
Effect: CONSTANT - Choose one of your opponent's Advanced Attacks. That attack gains a descriptor of your choice. You may negate the first time that this skill would be deactivated each Match. Costs 1 KI Point.
...
EQUIPMENT
Fusion Outfit [EQUIPPED; FULL BODY]
Inventory Slots: 0
...
Requirements: None
Training Days: 2
## Zen of the Guru [FREESTYLE, LATENT SKILL]
...
Description: The tiny mime-man taught you a technique he uses to intercept incoming attacks not through advanced martial arts maneuvers or split second dodging, but rather by standing his ground and manipulating his ki to psychically halt a foe in their place. The time they are stopped is short, but long enough to allow you the chance to deliver your own attack.
Effect: RESTRICTEDx1. Block. Stop a physical or energy attack. If your opponent's attack roll was 25 or higher, STUN. Costs X-1 KI Points.
## Classic Misdirection [FREESTYLE, BLOCK]
Description: Utilizing your surroundings, you're able to avoid an attack from your opponent. This can include hiding behind objects, masking yourself in fog or underwater, leaving a Ki trail to mask your real energy signature, or simply creating a burst of energy bigger than yourself so your opponent cannot aim.
Effect: RESTRICTEDx1. Stop a physical or energy attack. Your next attack roll gains +2 to the result. Costs X KI Points
## Twisted Timelines
